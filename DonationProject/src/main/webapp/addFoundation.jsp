...
<body>
  ...
  <div class="container">
    <div class="panel panel-primary dialog-panel">
        ...
        <h3>Add Foundation</h3>
      
      <div class="panel-body">
        <form class="form-horizontal" action="addFoundation1" role="form" method="post">
          ...
          <div class="form-group">
            ...
            <div class="col-md-offset-4 col-md-3">
              ...
              <button class="btn-lg btn-primary" type="submit" style="margin-left: 10px;"  onclick="redirectToManageCategory()">
 				 CanCel
			</button>
            </div>
