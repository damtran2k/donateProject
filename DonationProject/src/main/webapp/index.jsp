            ...
            <div class="item active">
              ...
              <div class="container">
                ...
                <div class="carousel-caption">
                  ...
                  <a href="loginSignUp.jsp" class="btn btn-lg btn-secondary hidden-xs bounceInUp animated slow" >DONATE NOW</a>
            ...
            <div class="item ">
              ...
              <div class="container">
                ...
                <div class="carousel-caption">
                  ...
                  <a href="loginSignUp.jsp" class="btn btn-lg btn-secondary hidden-xs bounceInUp animated" data-toggle="modal" data-target="#donateModal">DONATE NOW</a>
                    ...
                    <div class="cause">
                        ...
                        <div class="progress cause-progress">
                          <div class="progress-bar" role="progressbar" aria-valuenow="30" aria-valuemin="0" aria-valuemax="100" style="width: 30%;">
                            10$ / ${item.expectDonateMoney } 
                          </div>
                        </div>

                        <h4 class="cause-title"><a href="#">${item.name } </a></h4>
      ...
      <div class="modal-dialog">
        <div class="modal-content">
          ...
          <div class="modal-body">
                ...
                <form class="form-donation" action="/DonationProject/authorizePayment" method="post">
                        ...
                        <div class="row">
                            ...
                            <div class="form-group col-md-12 ">
                                <input type="text" class="form-control" id="amount" placeholder="AMOUNT(€)" name="money">
                            </div>
                       ...
                       <div class="row">
                            ...
                            <div class="form-group col-md-12">
                                <input type="text" class="form-control" name="usernameID" placeholder="UserNameID">
                            </div>
                        ...
                        <div class="row">
                            ...
                            <div class="form-group col-md-12">
                                <input type="text" class="form-control" name="fundID" placeholder="fund" value="${item.id }"  >
                            </div>
