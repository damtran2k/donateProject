...
<html lang="en">
  ...
  <c:choose>
    ...
    <nav  style="display: flex; justify-content: center; align-items: center;">
    	<form action="searchFund" method="get" style="margin-top: 20px;">
    	<select name="type" >
                <option>Name</option>
      ...
      <div class="table-responsive">
        <div class="table-wrapper">
          <div class="table-title">
            <div class="row">
              <div class="col-sm-6">
                <h2>Manage <b>Donation Fund</b></h2>
              </div>
            ...
            <thead>
              <tr>
                ...
                <th>Actions</th>       
          		  ...
          		  <form id="deleteItemsForm" action="deleteManyFund" method="post">
            	<tbody>
              ...
              <tr>
                ...
                <td>
                  <a href="editFund?id=${c.id }" class="edit" 
                    ><i
          ...
          <div class="clearfix">
            ...
            <c:forEach begin="1" end="${endPage }" var="i">
            	<li class="page-item"><a href="/DonationProject/listFundController?index=${i }" class="page-link">${i }</a></li>
            </c:forEach>
